...
<head>
  ...
  .leftCustomer-alert input[type=text] + label:after,
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">    
                      <li><a href="#" class="waves-effect waves-block waves-light"> <i  class="light" ><?php echo "IUG Restaurant" ;?></i></a>
                          </li>
                    </ul>	    
...
s.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
  ...
  <!-- START FOOTER -->
    <footer class="page-footer">
      <div class="footer-copyright">
        <div class="container">
          <span>Project ECOM4424: Restaurant Food Ordering System  </span>
          <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">IUG Students</a></span>
          </div>
      </div>
    </footer>
    <!-- END FOOTER -->
